                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                {{ Form::open(['route' => 'agent.profile.store', 'class' => 'forms-sample', 'method' => 'post' , 'files' => true,]) }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <x-textarea id="about" class="form-control" name="about"
                                        value="{{ $profileData->about != '' ? $profileData->about : '' }}" />
                                </div>
