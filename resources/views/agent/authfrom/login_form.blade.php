         ...
         <div class="row">
             <div class="col-xl-5 col-lg-6 mx-auto">
                 <div class="bg-white xs-p-20 p-30 border rounded">
                         ...
                         <h4 class="mb-4 text-dark">Agent Login </h4>
                         {{ Form::open(['route' => 'login', 'id' => 'loginform', 'class'=>'form-icon-left rounded form-boder', 'method' => 'post', 'autocomplete' => 'off']) }}
                         ...
                         <div class="row row-cols-1 g-3">
                             ...
                             <div class="col">
                                 ...
                                 <x-text-input id="password" class="form-control bg-light" type="password"
                             ...
                             <div class="col">
                                 {{-- <a href="#" class="text-dark d-table py-1">Forgot Password or Username</a> --}}
                                 <a href="{{ route('agent.register') }}" class="text-dark d-table py-1"><u>Don't have account? Click
                                         here.</u></a>
                             </div>
                         </div>
                         </form>
