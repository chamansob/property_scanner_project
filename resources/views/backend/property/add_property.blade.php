                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    {!! Form::label('property_name', 'Property Name(<span class="error">*</span>)', ['class' => 'form-label'],false)  !!}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <div class="pt-2">Please select image size less than 1 MB</div>
                                    <img src="" id="mainThmb">
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    {!! Form::label('agent', 'Agent ', ['class' => 'form-label'],false)  !!}
   ...
   <script>
        $(document).ready(function() {
            ...
            $('#cities_list').on('change', function() {
                ...
                var crf = '{{ csrf_token() }}';
                $.ajax({
                    url: "{{ route('neighborhoodcities.allneighborhoodcities') }}",
                    type: "POST",
                    data: {
                        _token: crf,
                        city_id: city_id
