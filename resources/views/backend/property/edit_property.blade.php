                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    {!! Form::label('property_status', 'Property Status', ['class' => 'form-label']) !!}
                                    <?php
                                    $status = [
                                        'rent' => 'Rent',
                                        'sale' => 'Sale',
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    {!! Form::label('lowest_price', 'Listing Price', ['class' => 'form-label']) !!}
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    {!! Form::label('max_price', 'Special Price', ['class' => 'form-label']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    {!! Form::label('garage', 'Maid Room', ['class' => 'form-label']) !!}

                                    {!! Form::number('garage', $value = $property->garage, [
                                        'class' => 'form-control',
                            ...
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    {!! Form::label('garage_size', 'Parkings', ['class' => 'form-label']) !!}

                                    {!! Form::number('garage_size', $value = $property->garage_size, [
                                        'class' => 'form-control',
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    {!! Form::label('postal_code', 'Developer', ['class' => 'form-label']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                        <div class="mb-3">
                                            {!! Form::label('propertysizes', '-', ['class' => 'form-label', 'id' => 'propertysizes']) !!}

                                            {!! Form::Select('propertysizes', $propertysizes, $property->property_size_type, [
                                                'class' => 'form-control',
                                            ]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    {!! Form::label('property_video', 'Property Video Url', ['class' => 'form-label']) !!}
                            ...
                            <div class="col-sm-4">
                                 <div class="mb-3">
                                    ...
                                    {!! Form::Select('neighborhood', $neighborhood, $property->neighborhood, [
                                        'class' => 'form-control',
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    {!! Form::label('latitude', 'Google Map Link', ['class' => 'form-label']) !!}

                                    {!! Form::text('latitude', $value = $property->latitude, [
                                        'class' => 'form-control',
                                        'placeholder' => 'Google Map Link',
                                    ]) !!}
                                    <div class="pt-2"><a href="https://www.google.com/maps/" target="_blank">Go
                                            Google Map</a></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::Select('agent_id', $agent, $property->agent_id, [
                                        'class' => 'form-control js-example-basic-single',
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open([
                            'method' => 'patch',
                            'route' => ['properties.update_img', $property->id],
                            'class' => 'forms-sample',
                            'files' => true,
                        ]) !!}
                        <div class="row">
