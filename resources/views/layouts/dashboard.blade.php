            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.wishlist, function(key, value) {
                        ...
                        <div class="col">
                                <!-- Property Grid -->
                                <div class="property-list-2 p-2 bg-white property-block border transation-this hover-shadow" id="${value.id}" onclick="wishlistRemove(this.id)" >
                                    <div class="overflow-hidden position-relative transation thumbnail-img bg-secondary hover-img-zoom">
                                        <div class="cata position-absolute"><span class="sale bg-secondary text-white">${value.property.property_status}</span></div>
                                        <div class="dot-disable nav-between-in">
                                            <div class="item">
                                                <a href="#"><img src="/${value.property.property_thumbnail
                                    ...
                                    <div class="property_text px-3">
                                        <span class="listing-price">$${(value.property.lowest_price)}</span>
                                        <h5 class="listing-title"><a href="#">${value.property.property_name}</a></h5>
                                         <span class="listing-location"><i class="fas fa-map-marker-alt"></i> $${(value.property.address)}</span>
                                        <ul class="d-flex quantity font-fifteen">
                                            <li title="Beds"><span><i class="fa-solid fa-bed"></i></span>${value.property.bedrooms}</li>
                                            <li title="Baths"><span><i class="fa-solid fa-shower"></i></span>${value.property.bathrooms}</li>
                                            <li title="Area"><span><i class="fa-solid fa-vector-square"></i></span>${value.property.property_size}</li>                                            
                                        </ul>
                                        <p>${value.property.short_descp} 
                                            <a href="#" class="btn-link">More Info...</a></p>
