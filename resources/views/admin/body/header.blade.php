                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    ...
                    <ul class="list-unstyled p-1">
                        <li class="dropdown-item py-2">
                            <a href="{{ Auth::user()->role == 'admin' ? route('admin.profile') : route('agent.profile') }}"
                        ...
                        <li class="dropdown-item py-2">
                            <a href="{{ Auth::user()->role == 'admin' ? route('admin.change.password') : route('agent.change.password') }}"
                                class="text-body ms-0">
                        ...
                        <li class="dropdown-item py-2">
                            <a href="{{ route('site.setting') }}" class="text-body ms-0">
                        ...
                        @endif
                        <li class="dropdown-item py-2">
                            <a href="{{ Auth::user()->role == 'admin' ? route('admin.logout') : route('agent.logout') }}"
                                class="text-body ms-0">
