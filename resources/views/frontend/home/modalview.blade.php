                        ...
                        <div class="row row-cols-xl-2 row-cols-1">
                            <div class="col">
                                <div class="overflow-hidden position-relative transation thumbnail-img bg-secondary hover-img-zoom m-2">
                                    ...
                                    <a href="#"><img class="w-100" src="{{ asset('frontend/assets/images/property/2.png') }}" alt=""></a>
                            ...
                            <div class="col">
                                <div class="property_text transation py-3 pe-3">
                                    ...
                                    <div class="d-flex align-items-center post-meta mt-2 py-3 border-top">
                                        <div class="agent">
                                            <a href="#" class="d-flex text-general align-items-center"><img class="rounded-circle me-2" src="{{ asset('frontend/assets/images/team/1.jpg') }}" alt="avata"><span>Ali Tufan</span></a>
                                        </div>
