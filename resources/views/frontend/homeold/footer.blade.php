                        ...
                        <div class="footer-widget contact-widget">
                            ...
                            <div class="widget-content">
                                <ul class="info-list clearfix">
                                    <li><i class="fas fa-map-marker-alt"></i>{{ $template->company_address }}</li>
                                    <li><i class="fas fa-microphone"></i><a
                                            href="tel:{{ $template->support_phone }}">{{ $template->support_phone }}</a>
                                    </li>
                                    <li><i class="fas fa-envelope"></i><a
                                            href="mailto:{{ $template->email }}">{{ $template->email }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
