      ...
      <div class="auto-container">
          <div class="inner-container">
              <div class="content-box centred">
                  <h2>Create Lasting Wealth Through Property Scanner</h2>
                  ...
                  <div class="tabs-box">
                      <div class="tab-btn-box">
                          <ul class="tab-btns tab-buttons centred clearfix">
                              <li class="tab-btn active-btn" data-tab="#tab-1">Rent</li>
                              <li class="tab-btn" data-tab="#tab-2">Sale</li>
                          </ul>
                      </div>
                          ...
                          <div class="tab active-tab" id="tab-1">
                              <div class="inner-box">
                                  <div class="top-search">
                                      {{ Form::open(['route' => 'property.search', 'class' => 'search-form', 'method' => 'post']) }}
                                          ...
                                          <div class="col-lg-4 col-md-6 col-sm-12 column">
                                              <div class="form-group">
                                                  ...
                                                  <div class="select-box">
                                                      ...
                                                      <select class="wide basic-single"
