...
class IndexController extends Controller
{
    ...
    public function propertyDetails($id, $slug)
    {
        ...
        $property = Property::where('id', $id)->where('status', 1)->first();
        if
        ($property!=null)
        {
    ...
    public function AgentDetails($id)
    {
        ...
        $property = Property::where('agent_id', $id)->paginate(2);
        $featured = Property::where('featured', '1')->limit(3)->get();
        $rentproperty = Property::where('property_status', 'rent')->where('agent_id', $id)->get();
        $saleproperty = Property::where('property_status', 'sale')->where('agent_id', $id)->get();
        return view('frontend.agent.agent_details', compact('agent', 'property', 'featured', 'rentproperty', 'saleproperty'));
    } // End Method 
    public function SaleProperty()
    {

        $property = Property::where('status', '1')->where('property_status', 'sale')->paginate(3);

        return view('frontend.property.sale_property', compact('property'));
    } // End Method 
    ...
    public function PropertySeach(Request $request)
    {
        //dd($request);
    ...
    public function StoreSchedule(Request $request)
    {
        ...
        if (Auth::check()) {
            ...
            Schedule::insert([
                ...
                'property_id' => $pid,
                'agent_id' => $aid,
                'tour_date' =>$request->tour_date->format('d/m/Y'),
